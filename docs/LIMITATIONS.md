...
- The packaged Action is self-tested on GitHub, but the approval-gated Codex workflow has not yet opened a remote draft remediation PR against a target repository with real model credentials.
