...
- [ ] Repeat 1: confirmed-no-delta; route no-model; 0 accepted model-origin finding(s).

- [ ] Repeat 2: confirmed-no-delta; route no-model; 0 accepted model-origin finding(s).

- [ ] Repeat 3: confirmed-no-delta; route no-model; 0 accepted model-origin finding(s).

## 102-feedback-entrypoint

- [ ] Repeat 1: completed; route sol-direct; 1 accepted model-origin finding(s).
...
- [ ] Repeat 2: completed; route sol-direct; 1 accepted model-origin finding(s).
...
- [ ] Repeat 3: completed; route sol-direct; 1 accepted model-origin finding(s).
...
- [ ] Repeat 1: failed; route sol-direct; 0 accepted model-origin finding(s).

- [ ] Repeat 2: failed; route sol-direct; 0 accepted model-origin finding(s).

- [ ] Repeat 3: failed; route sol-direct; 0 accepted model-origin finding(s).
...
- [ ] Repeat 3: completed; route sol-direct; 2 accepted model-origin finding(s).
...
- [ ] Repeat 1: completed; route sol-direct; 3 accepted model-origin finding(s).
...
- [ ] Repeat 2: completed; route sol-direct; 3 accepted model-origin finding(s).
...
- [ ] Repeat 1: completed; route sol-direct; 0 accepted model-origin finding(s).

- [ ] Repeat 2: completed; route sol-direct; 0 accepted model-origin finding(s).

- [ ] Repeat 3: completed; route sol-direct; 0 accepted model-origin finding(s).
...
- [ ] Repeat 1: completed; route sol-direct; 2 accepted model-origin finding(s).
...
- [ ] Repeat 2: completed; route sol-direct; 2 accepted model-origin finding(s).
